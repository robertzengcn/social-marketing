...
export class SearchTaskModel extends BaseDb {
   ...
   */
  async saveSearchTask(enginerId: number,num_pages?:number,concurrency?:number,notShowBrowser?:boolean,useLocalbrowserdata?:boolean,localBrowser?:string): Promise<number> {
