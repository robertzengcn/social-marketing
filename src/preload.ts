...
import {EXTRAMODULECHANNE_LIST,EXTRAMODULECHANNE_INSTALL,EXTRAMODULECHANNE_UNINSTALL,EXTRAMODULECHANNE_MESSAGE,OPENDIRECTORY,SYSTEM_MESSAGE,VIDEODOWNLOAD_MESSAGE,VIDEODOWNLOAD,VIDEODOWNLOAD_TASK_LIST,SEARCHSCRAPERAPI,LISTSESARCHRESUT,SEARCHEVENT,TASKSEARCHRESULTLIST,SAVESEARCHERRORLOG
  ...
  OUTREACH_SCRAPER_START,OUTREACH_SCRAPER_STOP,OUTREACH_SCRAPER_PROGRESS,OUTREACH_SCRAPER_STATUS,OUTREACH_CONTACT_LIST,OUTREACH_CONTACT_GET,OUTREACH_CONTACT_UPDATE,OUTREACH_CONTACT_DELETE,OUTREACH_MESSAGE_GENERATE,OUTREACH_MESSAGE_BATCH_GENERATE,OUTREACH_MESSAGE_UPDATE,OUTREACH_MESSAGE_REVIEW,OUTREACH_CAMPAIGN_CREATE,OUTREACH_CAMPAIGN_SEND,OUTREACH_CAMPAIGN_STATUS,OUTREACH_CAMPAIGN_LIST,
  ...
  // Utility Channels
  CRON_VALIDATE,CRON_NEXT_RUN_TIME,GET_LOGIN_URL,USER_CHECK_LOGIN,GET_APP_INFO} from "@/config/channellist";
...
contextBridge.exposeInMainWorld('api', {
    ...
    invoke: (channel, data) => {
      ...
      const validChannels = ['user:Login',USER_CHECK_LOGIN,'user:Signout','campaign:list','socialtask:list','socialtask:info','socialtasktype:list','tag:list','socialtask:save','socialtask:start','socialtaskrun:list','socialtaskresult:list',SOCIALACCOUNTlIST,SOCIALACCOUNTSAVE,'socialplatform:list','socialaccount:detail','socialaccount:delete',PROXYLIST,PROXYDELETE,PROXYSAVE,PROXYDETAIL,PROXYCHECK,PROXYIMPORT,EXTRAMODULECHANNE_LIST,OPENDIRECTORY,VIDEODOWNLOAD,VIDEODOWNLOAD_TASK_LIST,LISTSESARCHRESUT,SEARCHSCRAPERAPI,TASKSEARCHRESULTLIST,
        ...
        SCHEDULER_STATUS,SCHEDULER_START,SCHEDULER_STOP,SCHEDULER_RELOAD,
        // Utility Channels
        CRON_VALIDATE,CRON_NEXT_RUN_TIME,GET_LOGIN_URL,GET_APP_INFO]
      if (validChannels.includes(channel)) {
