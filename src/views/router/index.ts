...
export const constantRoutes: RouteRecordRaw[] = [
    ...
    children: [
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "staff-list" */ "@/views/pages/extramodules/extramoduleslist.vue"
          ),
        name: "Moduleslist",
        meta: {
          visible: true,
    ...
    children: [
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "staff-list" */ "@/views/pages/videodownload/index.vue"
          ),
        name: "Videodownload",
        meta: {
          visible: true,
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "staff-list" */ "@/views/pages/videodownload/list.vue"
          ),
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "staff-list" */ "@/views/pages/videodownload/videoList.vue"
          ),
        name: "VideoList",
        meta: {
          visible: false,
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "staff-list" */ "@/views/pages/videodownload/detail.vue"
          ),
        name: "VideoDetail",
        meta: {
          visible: false,
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "staff-list" */ "@/views/pages/videopublish/list.vue"
          ),
  ...
  },
  {
    ...
    children: [
      {
        path: "scraping-task",
        component: () => import("@/views/pages/outreach/ScrapingTask.vue"),
        name: "OutreachScrapingTask",
        meta: {
          visible: true,
          title: "route.scraping_task_list",
          icon: "mdi-web",
        },
      },
      {
        path: "contacts",
        component: () => import("@/views/pages/outreach/ContactList.vue"),
        name: "OutreachContactList",
        meta: {
          visible: true,
          title: "route.contact_list",
          icon: "mdi-contacts",
        },
      },
      {
        path: "message-generation",
        component: () => import("@/views/pages/outreach/MessageGeneration.vue"),
        name: "OutreachMessageGeneration",
        meta: {
          visible: true,
          title: "route.message_generation",
      ...
      },
      {
        path: "campaigns",
        component: () =>
          import("@/views/pages/outreach/CampaignManagement.vue"),
        name: "OutreachCampaignManagement",
        meta: {
          visible: true,
          title: "route.outreach_campaign_list",
