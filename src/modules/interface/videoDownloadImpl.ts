...
export interface videoDownloadImpl{
    ...
    downloadVideo(url:string,savePath:string,isSingleVideo:boolean,cookiesProxy?:CookiesProxy|null,proxy?:Proxy|null,execPath?:string,errorCall?:(errorMsg:string)=>void,stroutCall?:(message:string)=>void)
