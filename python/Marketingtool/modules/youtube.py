...
class Youtube():
    def __init__(self, client_id:str=None,
        ...
        self.secrets_file_path=CLIENT_SECRETS_FILE+str(uuid.uuid4())+'.json'
        self.client_secrets = {
                'web': {
                    'redirect_uris': [],
        ...
        self.oauth_path=OAUTH_FILE+str(uuid.uuid4())+'.json'
    def get_authenticated_service(self,access_token=None,
            refresh_token=None):
        # self.oauth_path = 'auth_'+str(uuid.uuid4()) + '.json'
        ...
        if not os.path.exists(self.secrets_file_path):
            raise FileNotFoundError("client secrets file not exists")
        # logger.info(CLIENT_SECRETS_FILE)
        flow = flow_from_clientsecrets(clientsecfile,
